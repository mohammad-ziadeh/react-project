    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-section footer-brand">
          ...
          <div className="social-icons" style={{ display: 'flex', gap: '50px' }}>
            <a href="https://x.com/?mx=2" style={{ color: 'pink' }}>
              <FaTwitter />
            </a>
            <a href="https://www.facebook.com/?locale=ar_AR" style={{ color: 'pink' }}>
              <FaFacebookF />
            </a>
            <a href="https://www.linkedin.com/" style={{ color: 'pink' }}>
              <FaLinkedinIn />
            </a>
          </div>
          <p>{t('©')}</p>
